...
//        return new ResponseEntity<UserResponse>(userService.saveMaster(newuser), HttpStatus.CREATED);
//
//    }
//
//    @PostMapping("/register/admin-user")
//    public ResponseEntity<UserResponse> save_admin_user(@RequestBody CreateUserRequest newuser){
//        return new ResponseEntity<UserResponse>(userService.saveAdminUser(newuser), HttpStatus.CREATED);
//
//    }
//
//    @PostMapping("/register/admin-app")
//    public ResponseEntity<GetUserDTO> save_admin_app(@RequestBody CreateUserRequest newuser){
//        return new ResponseEntity<GetUserDTO>(userService.saveAdminApp(newuser), HttpStatus.CREATED);
//
//    }
//
//    @PostMapping("/register/client")
//    public ResponseEntity<GetUserDTO> save_client(@RequestBody CreateUserRequest newuser){
